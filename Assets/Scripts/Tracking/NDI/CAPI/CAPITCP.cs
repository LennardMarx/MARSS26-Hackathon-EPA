        ...
        public override bool Disconnect()
        {
            ...
            if (_listenThread != null)
            {
                ...
                if (_listenThread.IsAlive) {
                    _listenThread.Abort();// This is really not good and might cause problems in the future. I don't
                    // know why sometimes the thread does not join. In CAPI.cs I made a comment, we can try when
